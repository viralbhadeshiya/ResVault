...
class rword {
    ...
    static generate(count = 1, opt) {
        ...
        const indexes = (0, generate_indexes_1.generateIndexes)(pool.length, count);
        const temp = [];
     ...
     */
    static shuffle() {
        (0, shuffle_words_1.shuffleWords)(words);
        (0, shuffle_words_1.shuffleWords)(rword.globalPool);
    }
    /**
